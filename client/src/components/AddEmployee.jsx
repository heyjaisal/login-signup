...
//     try {
//      const response = await onAdd({ name, position, contact }); 
//       setName('');
//       setPosition('');
//       setContact('');
//     } catch (err) {
...
//   return (
//     <form onSubmit={handleAdd} className="mt-3 mx-auto" style={{ maxWidth: "600px" }}>
...
//     try {
//       await onAdd({ name, position, contact });
//       setName('');
//       setPosition('');
//       setContact('');
//     } catch (err) {
//       setError(err.response?.data?.error || 'Failed to add employee');
//     } finally {
//       // Clear the input fields only if the form submission is successful
//       setName('');
//       setPosition('');
//       setContact('');
//     }
